...
public class CAdresseIP extends UnicastRemoteObject implements CAdresseIPInterface{

	// Tableau des 4 octets de l'adresse IP.
	private int o[];

	public CAdresseIP(String adr) throws RemoteException, UnknownHostException {
